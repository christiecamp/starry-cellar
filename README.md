...
`STARRY CELLAR STUFF` is an e-commerce site that utilizes [Node.js](https://nodejs.org/en), [Express.js](https://www.npmjs.com/package/inquirer), [Sequelize](https://www.npmjs.com/package/sequelize), and [MySQL](https://www.mysql.com) database.
